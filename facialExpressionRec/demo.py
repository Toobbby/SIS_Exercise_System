    ...
    while True:
        ...
        if detected_face is not None:
            ...
            if ((result[0][0] + result[0][1] + result[0][2]) > (
                ...
                print("The Patient is Not Calm")
                resultfile = open("/Users/fguo/Desktop/SISv5/Components/Camera/result.txt", "w")
                resultfile.write("Not Calm")
                resultfile.close()


            else:
                print("The Patient is Calm")
                resultfile = open("/Users/fguo/Desktop/SISv5/Components/Camera/result.txt", "w")
                resultfile.write("Calm")
                resultfile.close()
